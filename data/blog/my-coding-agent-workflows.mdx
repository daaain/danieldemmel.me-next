...
After I posted a [thread on Reddit](https://www.reddit.com/r/ClaudeCode/comments/1oka6k1/the_single_most_useful_line_for_getting_what_you/) about a simple but effective method of prompting Claude Code to ask clarifying questions, Abhishek Ray (YC founder from San Francisco) got in touch asking if I'd be up for a chat with a quick demo and I thought why not:

<EmbedVimeo code="1136426353" hash="deadbeef" />

This finally made me sit down a gather my thoughts about what I learnt in the last half year since Claude Code came out as I didn't want to appear like a nitwit on the podcast 😅
...
- **strong typing** with no `any`s or other workarounds and escape hatches as these can disable type safety for entire downstream sections – I guess more relevant for TypeScript and Python I use as this is a given with Java for example
...
- **reproducible development environment** with Docker Compose – running it in daemonised mode so both me and the agent can tail the logs
