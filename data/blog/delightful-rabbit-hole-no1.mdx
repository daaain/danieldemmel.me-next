...
My Pixel 6 Pro also doesn't have a macro lens, so I fixed focus to shortest on the main camera (the telephoto one was quite hopeless with a super long minimum distance) and moved the actual phone until the subjects were sharp(ish). This yielded much nicer photos:
