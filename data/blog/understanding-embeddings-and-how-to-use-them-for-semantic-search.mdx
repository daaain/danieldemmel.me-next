...
To produce the posts from the recorded talk, I used [Whisper.cpp](https://github.com/ggerganov/whisper.cpp) to transcribe what I said and asked GPT-4 to clean up the transcription. Then I edited the text to add some missing bits and make it sound less like a robot 🤖
