...
I'd know, I've been harping on about [containerising dev environments](/blog/containerise-everything) for more than a decade! Dev containers have been around for years too, I gave them a go a few times, but never got to a point where they felt good enough. Now finally, with a bit of LLM help to keep the momentum and the kinks of the implementation ironed out throughout the years, I managed to set it up in a way that makes dev experince better rather than compromise it!
