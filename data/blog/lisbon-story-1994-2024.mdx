...
It was impossible to properly recreate the shots with our phone cameras, not only because of the film grain, but very different (I think longer) lens and possibly yellow filter. So we didn't overdo it to perfection, but I think it's still fun to see them as diptychs and I tried to line up at least one element in each pair.
