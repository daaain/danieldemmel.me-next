...
I was curious about these differences, so built a tool in which you can type any text, see how it would get tokenised, and compare several models side-by-side: [Online LLM Tokenizer](/tokenizer/)
