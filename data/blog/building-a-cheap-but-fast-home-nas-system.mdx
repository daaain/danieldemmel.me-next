---
title: Building a cheap but fast home NAS system
date: 2023-06-16
tags: [truenas, open source, nas, permacomputing, diy]
...
I've been reading about [Permacomputing](https://permacomputing.net/) (that I discovered through [Devine](https://merveilles.town/@neauoire) of [Hundred Rabbits](https://100r.co/site/home.html) fame, thanks!) so I was also considering that – even though I would like a more powerful NAS than the current one – being a little home server it really doesn't need to be the latest technology.
...
First, I found a refurbished [HP ProDesk 600 G3 Mini for £140 on BackMarket](https://www.backmarket.co.uk/en-gb/p/hp-prodesk-600-g3-mini-core-i5-6500t-25-ssd-256-gb-8gb/af174e7f-f3d1-44e9-bc40-ae7384433d9c#l=11) which is not a bad deal considering that it comes with a year of warranty.

![Screenshot of cheap refurbished PC](/images/2023/backmarket-refurbished-pc.png)
...
![Screenshot of my tiny PC with a banner showing offer accepted](/images/2023/tiny-pc-on-ebay.png)

For choosing the right CPU it took me a while to realise that Intel has a relatively decent naming and numbering scheme where the first 1-2 digit is the generation, the following 3 digits are the class (i3/i5/i7) and the "T" postfix is the low energy version that I can highly recommend for this use case (35W peak instead of 60W). So in case of my 6500T, it's a low energy 6th generation i5, that currently is the best value, but you could try looking for 7500T or 8500T too and see if you get lucky. I'd avoid any Atom or Celeron ones as they are very slow (unless you're going for super low power), get i3 only if it's very cheap and a recent generation and skip i7 as usually it's a bit overpriced.
...
![CPU comparison](/images/2023/cpu-comparison.png)
...
![Screenshot of SSD on e-commerce website named after the huge rainforest](/images/2023/screenshot-of-SSD.png)
