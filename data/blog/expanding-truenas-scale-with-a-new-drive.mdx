...
This is a follow-up post to [Installing and configuring TrueNAS Scale for home use](./installing-and-configuring-truenas-scale-for-home-use) in which I wrote up how to set up TrueNAS Scale on a micro PC. Now I will show you how to expand the storage capacity by adding a new drive.
